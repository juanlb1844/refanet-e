...
<element>
    <div class="grid-stack-item ui-draggable ui-resizable ui-resizable-autohide" data-bind="attr: {'data-gs-x': $data.x, 'data-gs-y': $data.y, 'data-gs-width': $data.width, 'data-gs-height': $data.height, 'data-gs-auto-position': $data.auto_position}" data-gs-x="0" data-gs-y="2" data-gs-width="3" data-gs-height="4">       <div class="grid-stack-item-content ui-draggable-handle"><iframe class="chartjs-hidden-iframe" tabindex="-1" style="display: block; overflow: hidden; border: 0px; margin: 0px; inset: 0px; height: 100%; width: 100%; position: absolute; pointer-events: none; z-index: -1;"></iframe><button data-bind="click: $root.deleteWidget" class="pull-left btn btn-default" style="font-weight: bold; color: #656565; border: 1px solid #e5e5e5;">×</button> </div>   <div class="ui-resizable-handle ui-resizable-se ui-icon ui-icon-gripsmall-diagonal-se" style="z-index: 90; display: none;"></div></div>
</element>
                        ...
                        $.ajax({
                                ...
                                success: function(response) {
                                  ...
                                  for( var i = 0 in dataDash ) {
                                    console.log( dataDash[i].distributor_name ); 
